...
{
  if (a && [a isMemberOfClass: FSNumberClass] && b && [b isMemberOfClass: FSNumberClass])
  {
...
{
  if (operand && [operand isMemberOfClass: FSNumberClass] && value >=0 && ((FSNumber *)operand)->value >= 0 && value <= UINT_MAX && ((FSNumber *)operand)->value <= UINT_MAX && value == floor(value) && ((FSNumber *)operand)->value == floor(((FSNumber *)operand)->value))
...
{
  if (operand && [operand isMemberOfClass: FSNumberClass]) return value > ((FSNumber *)operand)->value ? (NSNumber *)self : operand;
...
{  
  if (operand && [operand isMemberOfClass: FSNumberClass]) return numberWithDouble(value * ((FSNumber *)operand)->value);
...
{
  if (operand && [operand isMemberOfClass: FSNumberClass] && value >= -CGFLOAT_MAX && value <= CGFLOAT_MAX && ((FSNumber *)operand)->value >= -CGFLOAT_MAX && ((FSNumber *)operand)->value <= CGFLOAT_MAX)
...
{
  if (operand && [operand isMemberOfClass: FSNumberClass] && ((FSNumber *)operand)->value != 0.0) 
...
{ 
  if (operand && [operand isMemberOfClass: FSNumberClass])  return (value == ((FSNumber *)operand)->value ? fsTrue : fsFalse);
...
{
  if (operand && [operand isMemberOfClass: FSNumberClass]) 
  {
...
{
  if (anObject && [anObject isMemberOfClass: FSNumberClass]) // direct isa access for better performance
