/* FSCoreDataSample.m Copyright (c) 2005-2009 Philippe Mougin.  */
...
+ managedObject
{
  ...
  [employeeEntity setProperties:@[firstNameAttribute, lastNameAttribute, salaryAttribute, phoneAttribute, emailAttribute, addressAttribute, managerRelationship, directReportsRelationship, departmentRelationship]];
  [departmentEntity setProperties:@[nameAttribute, budgetAttribute, employeesRelationship]];

  NSArray *entities = @[departmentEntity, employeeEntity];
  ...
  [department1 setValue:@450000 forKey:@"budget"]; 
  ...
  [department2 setValue:@575000 forKey:@"budget"]; 
  ...
  [department3 setValue:@10000 forKey:@"budget"]; 
  ...
  [department4 setValue:@110000 forKey:@"budget"]; 
  ...
  [employee1 setValue:@3000 forKey:@"salary"];
  ...
  [employee2 setValue:@3700 forKey:@"salary"];
  ...
  [employee3 setValue:@3800 forKey:@"salary"];
  ...
  [employee4 setValue:@4300 forKey:@"salary"];
  ...
  [employee5 setValue:@2200 forKey:@"salary"];
  ...
  [employee6 setValue:@4000 forKey:@"salary"];
  ...
  [employee7 setValue:@3750 forKey:@"salary"];
  ...
  [employee8 setValue:@3550 forKey:@"salary"];
  ...
  [employee9 setValue:@3200 forKey:@"salary"];
  ...
  [employee10 setValue:@3000 forKey:@"salary"];
  ...
  [employee11 setValue:@3900 forKey:@"salary"];
  ...
  [employee12 setValue:@3000 forKey:@"salary"];
  ...
  [employee13 setValue:@3400 forKey:@"salary"];
  ...
  [employee14 setValue:@3800 forKey:@"salary"];
